...
def analyzeline(m, case, line):
    ...
    if case in ['begin', 'call', 'callfun']:
        ...
        typespec, selector, attr, edecl = cracktypespec0(
            block, m.group('after'))
        lastName = updatevars(typespec, selector, attr, edecl)
        if lastName is not None:
            previous_context = ('variable', lastName, groupcounter)
...
def updatevars(typespec, selector, attrspec, entitydecl):
    """
    Returns lastName, the variable name without special chars, parenthesis
